<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="TutorialWcf6.WebClient.WebForm1" %>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlEmployeeType" runat="server" 
                        onselectedindex="ddlEmployeeType_SelectedIndexChanged" AutoPostBack="True" OnSelectedIndexChanged="ddlEmployeeType_SelectedIndexChanged">
